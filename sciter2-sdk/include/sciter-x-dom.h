 ...
 */
 ...
 typedef VOID CALLBACK LPCSTR_RECEIVER( LPCSTR str, UINT str_length, LPVOID param );
...
EXTERN_C SCDOM_RESULT SCAPI SciterGetHighlightedElement(HWND hwnd, HELEMENT* phe);
EXTERN_C SCDOM_RESULT SCAPI SciterSetHighlightedElement(HWND hwnd, HELEMENT he);

//|
//| Nodes API 
//|

// ATTENTION: node handles returned by function below are not AddRef'ed
